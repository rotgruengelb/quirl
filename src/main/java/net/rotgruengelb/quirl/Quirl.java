...
public class Quirl implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        if (MOD_TEST_MODE) {
            ...
            CustomShovelBlockInteract.addResult(Blocks.ACACIA_PLANKS.getDefaultState(), Blocks.DIRT.getDefaultState(), SoundEvents.ITEM_SHOVEL_FLATTEN, SoundCategory.BLOCKS);
        }
    }
}